  ...
  switch(choice)
  {
   case 1:
   {
    ...
    switch(accessoriesChoice)
    {
     ...
     {
      int num;
      printf("You choose KeyBoard with Rs.700.Are you sure to buy.If 'Yes' Enter 1 else any number\n");
      scanf("%d",&num);
      if(num==1)
      {
       a[0]++;
     ...
     {
      int num;
      printf("You choose Logitech Mouse with Rs.500.Are you sure to buy.If 'Yes' Enter 1 else any number\n");
      scanf("%d",&num);
      if(num==1)
      {
       a[1]++;
   ...
   case 2:
   {
    ...
    switch(shoesChoice)
    {
     ...
     {
      int num;
      printf("You choose Adidas Shoes for Rs.3550.Are you sure to buy.If 'Yes' Enter 1 else any number\n");
      scanf("%d",&num);
      if(num==1)
      {
       a[3]++;
     ...
     {
      int num;
      printf("You choose Nike Shoes for Rs.5000.Are you sure to buy.If 'Yes' Enter 1 else any number\n");
      scanf("%d",&num);
      if(num==1)
      {
       a[4]++;
     ...
     {
      int num;
      printf("You choose Leecooper Shoes for Rs.2800.Are you sure to buy.If 'Yes' Enter 1 else any number\n");
      scanf("%d",&num);
      if(num==1)
      {
       a[5]++;
   ...
   case 3:
   {
    ...
    switch(mobileChoice)
    {
     ...
     {
      int num;
      printf("You choose to buy Nokia 3 for Rs.9866.Are you sure to buy.If 'Yes' Enter 1 else any number\n");
      scanf("%d",&num);
      if(num==1)
      {
       a[7]++;
     ...
     {
      int num;
      printf("You choose to buy Samsung for Rs.12800.Are you sure to buy.If 'Yes' Enter 1 else any number\n");
      scanf("%d",&num);
      if(num==1)
      {
       a[8]++;
